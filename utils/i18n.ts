  ...
  ko: {
    translation: {
      ...
      app: {
        ...
        patchNotes: {
          title: '패치 내역',
          v1_0_0: 'v1.0.0: 다국어 지원',
          v1_1_0: 'v1.1.0: 프로토콜 선택 기능 추가',
          close: '닫기',
        },
      ...
      help: {
        ...
        note: '만약 포함되지 않는다면 이는 해당 앱에서 측정 불가능한 기기입니다.',
        protocols: '프로토콜:',
        protocolsList: 'FTMS, CSC, NUS, HRS, CPS, BMS, DIS',
      ...
      test: {
        ...
        limitations: {
          ...
          gearChange: '• 소프트웨어에서 직접 기기의 기어 변경이 불가능합니다',
        ...
        protocols: {
          ...
          cps: {
            ...
            monitoring: 'CPS 데이터 모니터링 중...',
            dataCollection: 'CPS 데이터 수집 중...',
            complete: 'CPS 테스트 완료',
          },
          bms: {
            detectedButNotTested: 'BMS protocol detected but not tested (low priority)',
            monitoring: 'BMS 데이터 모니터링 중...',
            dataCollection: 'BMS 데이터 수집 중...',
            complete: 'BMS 테스트 완료',
          },
          dis: {
            detectedButNotTested: 'DIS protocol detected but not tested (low priority)',
            monitoring: 'DIS 데이터 모니터링 중...',
            dataCollection: 'DIS 데이터 수집 중...',
            complete: 'DIS 테스트 완료',
          },
        ...
        protocolSelection: '프로토콜 선택',
        reconnecting: '재연결 중...',
        noProtocols: '사용 가능한 프로토콜 없음',
      },
  ...
  en: {
    translation: {
      ...
      app: {
        ...
        patchNotes: {
          title: 'Patch Notes',
          v1_0_0: 'v1.0.0: Multilingual support',
          v1_1_0: 'v1.1.0: Added protocol selection feature',
          close: 'Close',
        },
      ...
      help: {
        ...
        note: 'If not included, this device cannot be measured with this app.',
        protocols: 'Protocols:',
        protocolsList: 'FTMS, CSC, NUS, HRS, CPS, BMS, DIS',
      ...
      test: {
        ...
        limitations: {
          ...
          gearChange: '• It is not possible to change the device gear directly from the software.',
        ...
        protocols: {
          ...
          cps: {
            detectedButNotTested: 'CPS protocol detected but not tested (low priority)',
            monitoring: 'Monitoring CPS data...',
            dataCollection: 'Collecting CPS data...',
            complete: 'CPS test complete',
          },
          bms: {
            detectedButNotTested: 'BMS protocol detected but not tested (low priority)',
            monitoring: 'Monitoring BMS data...',
            dataCollection: 'Collecting BMS data...',
            complete: 'BMS test complete',
          },
          dis: {
            detectedButNotTested: 'DIS protocol detected but not tested (low priority)',
            monitoring: 'Monitoring DIS data...',
            dataCollection: 'Collecting DIS data...',
            complete: 'DIS test complete',
          },
          noSupportedProtocols: 'No supported protocols found. Priority: MOBI > REBORN > TACX > FITSHOW > YAFIT_S3 > YAFIT_S4 > FTMS > CSC',
          incompatibleProtocol: 'Incompatible protocol',
        },
    ...
    translation: {
      ...
      test: {
        ...
        protocols: {
          ...
          cps: {
            detectedButNotTested: 'CPS protocol detected but not tested (low priority)',
            monitoring: '正在监控CPS数据...',
            dataCollection: '正在收集CPS数据...',
            complete: 'CPS测试完成',
          },
          bms: {
            detectedButNotTested: 'BMS protocol detected but not tested (low priority)',
            monitoring: '正在监控BMS数据...',
            dataCollection: '正在收集BMS数据...',
            complete: 'BMS测试完成',
          },
          dis: {
            detectedButNotTested: 'DIS protocol detected but not tested (low priority)',
            monitoring: '正在监控DIS数据...',
            dataCollection: '正在收集DIS数据...',
            complete: 'DIS测试完成',
          },
          noSupportedProtocols: 'No supported protocols found. Priority: MOBI > REBORN > TACX > FITSHOW > YAFIT_S3 > YAFIT_S4 > FTMS > CSC',
          incompatibleProtocol: 'Incompatible protocol',
